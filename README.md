...
### Глубина ядра (Фаза 2.5) — начата: Прилив 🌊
...
- Следующие механики (в плане): ходы как ресурс 🧮, позиционные цели 🪸,
  акула-охотник 🦈, плитки-способности ⚡.
...
```bash
npm install
npm run test           # 227 юнит-тестов (node:test)
...
| 2.5 | «Глубина ядра» (главный приоритет): **Прилив 🌊 — готово**, ходы как ресурс, позиционные цели, акула-охотник, плитки-способности | 🟡 в работе (1/5) |
